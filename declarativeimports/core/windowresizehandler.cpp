...
//! Vendored from libplasma v6.6.5, see windowresizehandler.h for provenance
//! and the one deliberate deviation (the resizeStarted() signal).
    ...
    case QEvent::MouseButtonRelease: {
        ...
        if (event->type() == QEvent::MouseButtonPress) {
            ...
            if (sides) {
                ...
                //! Latte addition, see the header
                Q_EMIT resizeStarted();
                return true;
            }
        }
    } break;
