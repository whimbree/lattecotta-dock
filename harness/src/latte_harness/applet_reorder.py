...
bridge. applet-reorder-driver.sh stays in place for the bash applet-reorder recipe
(100) until the BP-3 driver batch ports and deletes it, so this module and the
bash lib coexist. The coordinate math (_compute_points) is pure so it is
