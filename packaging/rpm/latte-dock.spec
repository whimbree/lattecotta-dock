...
BuildRequires:  %{qtbase_devel_pkg} >= 6.9
BuildRequires:  %{qtdeclarative_devel_pkg} >= 6.9
BuildRequires:  %{qtwayland_devel_pkg} >= 6.9
...
Requires:       %{qtdeclarative_runtime_pkg} >= 6.9
Requires:       %{qt5compat_runtime_pkg} >= 6.9
