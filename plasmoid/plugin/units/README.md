# Pure cores for the tasks plasmoid plugin

Behavioral logic extracted out of the plasmoid package QML per
...
Provenance matters in this subtree: plasmoid/plugin carries files
vendored from plasma-desktop (see the fork-sync recipe in CLAUDE.md).
Files under units/ are Latte-authored, never vendored, and carry
Latte provenance headers so the vendor-sync diff stays clean -
extraction commits do not edit the vendored files.
