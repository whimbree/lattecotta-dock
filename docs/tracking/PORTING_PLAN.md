...
- [x] Fix D107 (linked applet removal left member projections persistent). Keep
      ...
      projections immediately, and recreate their fresh local identities and
...
- [ ] Observability first - everything instrumentable, D-Bus as the
      ...
      Each was corrected and recorded below. The first canonical gate passed at
      `cf1a85acad6342bb4c59bca0e86b41b3e4d00281`, then was invalidated by
      those code corrections. The final canonical gate exited 0 at exact
      pre-merge head `11bd5f5dcfaf43bcc42f5eea5153bf2f42213448` before
      GitHub's rebase merge rewrote the commits.
      Commits: c11c77ed2 (D76), 5591b66d7 (C0 implementation), 9767ea4fb
      (public contract), 30ecf6bfc + e853e196a (D90), 85e59ee07 (D85),
      f9c5af8df (D86), cd478bb06 (D92), 4fa619870 (D91 and final record)
...
- [x] Fix D206 (heterogeneous task rows suppressed touching-window state).
      ...
      Commits: 36e835fb9, fd445ee2f (PR #124)
...
- [x] Fix D245 (partial Panels lost endpoint borders at live attachment).
      ...
      edge and output origin. Positioner publishes one applied surface, output
      geometry, placement generation, and forced-border snapshot only after
      LayerShell accepts the placement. Solver scratch, mutable screen
...
- [x] Fix D257 (the real-desktop launcher omitted KWin authority for worktree
      binaries). Register the exact `BUILD` executable and the shipped
      privileged Wayland interface list at the shared real-config restart
...
- [x] Fix D259 (floating attachment reused the slower whole-Dock slide timing).
...
- [x] Fix D262 (Auto Hide and Dodge reveal used a client ghost instead of
      ...
      Commits: cac8efab0, 1fc78b493, 29e1b3008
...
- [x] Fix D265 (linked docks gave no passive edit cue). Derive a read-only
      ...
      Commits: 08d2c3985, 0f78b52b8, fb340286d, 23e30c4f0, 141fd0b5e
